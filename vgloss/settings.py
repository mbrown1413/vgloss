"""
Django settings for vgloss project.
...
try:
    BASE_DIR = os.path.abspath(os.environ["VGLOSS_BASE"])
except KeyError:
    BASE_DIR = os.getcwd()
...
WSGI_APPLICATION = 'vgloss.wsgi.application'
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'America/New_York'  #TODO: Set this on initialization in a txt file
USE_I18N = True
USE_L10N = True
USE_TZ = True
